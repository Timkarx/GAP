from gap_ratings.team_data.parameters import *
class Teams:
    """Describes attributes of a football team"""
    """gap_rat means gap ratings"""
    ...
    def calc_away_gap_rat(home_team, away_team, home_gap_input, away_gap_input):
        ...
        away_team_new_HA = parameter_2 * away_team_new_AA
        away_team_new_HD = parameter_2 * away_team_new_AD
